              ...
              <ShadcnTableCell class="tw-border-y">
                <ShadcnDropdownMenu>
                  ...
                  <ShadcnDropdownMenuContent align="end">
                    <ShadcnDropdownMenuLabel>BAPP</ShadcnDropdownMenuLabel>
                    <ShadcnDropdownMenuItem
                      @click="() => handleCreateBAPP(row)"
                    >
                      Create
                    </ShadcnDropdownMenuItem>
                    <ShadcnDropdownMenuItem @click="() => handleViewBAPP(row)">
                      View
                    </ShadcnDropdownMenuItem>
                    <ShadcnDropdownMenuSeparator />
                    <ShadcnDropdownMenuLabel>BAST</ShadcnDropdownMenuLabel>
                    <ShadcnDropdownMenuItem
                      @click="() => handleCreateBAST(row)"
                    >
                      Create
                    </ShadcnDropdownMenuItem>
                    <ShadcnDropdownMenuItem @click="() => handleViewBAST(row)">
                      View
                    </ShadcnDropdownMenuItem>
                    <ShadcnDropdownMenuSeparator />
                    ...
                    <ShadcnDropdownMenuItem @click="() => handleFillForm(row)">
                      Fill Form
                    </ShadcnDropdownMenuItem>
